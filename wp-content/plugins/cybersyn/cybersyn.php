...
The <a href="http://www.cyberseo.net/" target="_blank"><strong>CyberSEO plugin</strong></a> is an extended version of CyberSyn with a rich set of unique features. With CyberSEO you can:<br />
<ul style="list-style-type: disc; list-style-position: outside; margin-left: 15px;">
    <li>- No "lite" editions anymore. Now there is only one edition of CyberSEO and it is unlimited.</li>
    <li>- Since version 7, the plugin is compatible with PHP 5.3.3 and greater.</li>
    <li>- CSV and text dump imports now supported. Import with ease raw text dumps and Excel-style CSV files into WordPress posts and pages.</li>
    <li>- HTML and JSON sources are also supported now.</li>
    <li>- Since version 7 the internal structure of XML and JSON sources is recognized and parsed automatically.</li>
    <li>- Full support of the Hyper Text Transfer Protocol Secure (HTTPS).</li>
    <li>- Optimized code and new improved interface.</li>
    <li>- Autoupdate feature added. Now CyberSEO updates itself automatically.</li>
    <li>- <a href="http://www.cyberseo.net/content-syndicator/#templates" target="_blank" rel="noopener">Post templates</a> allow one to easily import XML items and define the post layout.</li>
    <li>- <a href="http://www.cyberseo.net/presets/" target="_blank" rel="noopener">Presets</a> added. This is a very powerful feature which allows one to choose predefined feed settings from the library. So if you want to import some feed as an image gallery, as a tube video, as a full text article etc, do it with a couple of mouse clicks!</li>
    <li>- New full text extraction method. No 3rd-party Web services anymore - all the scripts run at your own host.</li>
    <li>- Automatic translation to/from over 100 languages via Google Translate and Yandex Translate services.</li>
    <li>- Media attachment handling for video and audio files.</li>
    <li>- Correct permalinks for spun (synonymized) post titles were finally implemented.</li>
    <li>- Fixed the known problem with feed edition while plugin is active.</li>
    <li>- The 3rd-party <a href="http://www.cyberseo.net/partners/espinner.php" target="_blank rel="noopener">ESpiner</a> spinner service support added.</li>
    <li>- Auto tags generation added.</li>
    <li>- A featured image now can be generated from media attachment thumbnails.</li>
</ul>
</div>';
...
function csyn_preset_options() {
    ...
    if (get_option(CSYN_CANONICAL_LINK) === false) {
        csyn_set_option(CSYN_CANONICAL_LINK, 'auto', '', 'yes');
    }
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><select name="set_thumbnail" size="1">
                        ...
                        <p class="description"><strong>if the plugin will not be able to create post thumbnail (e.g. the source image is missing or broken), the post will be deleted.
                                So if you are going to enable the post thumbnail generation, please make sure that images are available in your content source.</strong></p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><?php
                        ...
                        <p class="description">Use <strong>####post_link####</strong> keyword to insert a link to the original article.</p>' . "\n";
                        ?>
                    </td>
                </tr>
